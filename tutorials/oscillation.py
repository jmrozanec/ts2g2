...
def graphToTime_sequence_one_least(graph, nodes_1, nodes_2, color_1, color_2, time_series_len = 100):
    sequence_1 = []
    sequence_2 =[]
...
def graphToTime_sequence_one_random(graph, nodes_1, nodes_2, color_1, color_2, time_series_len = 100):
    sequence_1 = []
    sequence_2 =[]
...
def graphToTime_sequence_random(graph, nodes_1, nodes_2, color_1, color_2, time_series_len = 100):
    sequence_1 = []
    sequence_2 =[]
